...
# DSN-Vocal API Server
# Modified from inference_webui.py and api.py
# Update 240827
...
print(f"半精度推理: {is_half}")

cnhubert_base_path = cwd+"\\instances\\DSN-vocal\\GPT_SoVITS\\pretrained_models\\chinese-hubert-base"
bert_path = cwd+"\\instances\\DSN-vocal\\GPT_SoVITS\\pretrained_models\\chinese-roberta-wwm-ext-large"
...
def get_tts_wav(ref_wav_path, prompt_text, prompt_language, text, text_language):
    ...
    #print(prompt_language, text_language)
