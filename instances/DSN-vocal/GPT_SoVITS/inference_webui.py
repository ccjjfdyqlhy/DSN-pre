...
with gr.Blocks(title="语音合成",theme=gr.themes.Soft()) as app:
    with gr.Group():
        ...
        with gr.Row():
            ...
            how_to_cut = gr.Radio(
                label=i18n("断句策略"),
                choices=[i18n("不断句(可能导致严重问题)"), i18n("每四句一切"), i18n("每50字一切"), i18n("按中文句号切"), i18n("按英文句号切"), i18n("按标点符号切"), ],
                value=i18n("凑四句一切"),
                interactive=True,
            )
        ...
        gr.Markdown(value=i18n("手动断句工具"))
        with gr.Row():
            text_inp = gr.Textbox(label=i18n("需要合成的切分前文本"), value="")
            button1 = gr.Button(i18n("每四句一切"), variant="primary")
            button2 = gr.Button(i18n("每50字一切"), variant="primary")
            button3 = gr.Button(i18n("按中文句号切"), variant="primary")
            button4 = gr.Button(i18n("按英文句号切"), variant="primary")
